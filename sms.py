    ...
    def analyze_student_trends(self, student_id, days=30):
        ...
        try:
            ...
            if trends['attendance_trend'] == 'improving':
                ...
                trend_parts.append("➡️ Attendance is stable")
    ...
    def compare_student_to_class(self, student_id):
        ...
        try:
            ...
            if student_attendance > class_avg + 10:
                ...
                comparison['comparison_text'] = f"➡️ Student performs near class average"
            else:
...
class SchoolManagementSystem:
    ...
    def show_teacher_class_selection(self):
        ...
        info_label = tk.Label(info_content, text="📚 Teacher Dashboard Features:", 
...
Note: Classes are created and managed by administrators. Teachers can only select from existing classes."""
    ...
    def create_student_management_tab(self):
        ...
        header_label = tk.Label(header_frame, text="📚 Class Students Overview", 
    ...
    def create_students_list(self, parent):
        ...
        for i, student in enumerate(students_data):
            ...
            # View profile button
            profile_btn = tk.Button(actions_frame, text="👁️ Profile", 
    ...
    def create_assignments_interface(self, parent):
        ...
        modules_notebook.add(homework_frame, text="📚 Homework")
    ...
    def manage_student_attendance(self, student):
        ...
        late_rb = tk.Radiobutton(today_frame, text="⏰ Late", variable=attendance_var, 
    ...
    def write_student_remarks(self, student):
        ...
        # View history button
        history_btn = tk.Button(buttons_frame, text="📚 View History", 
    ...
    def view_remarks_history(self, student):
        ...
        tk.Label(header, text=f"📚 Remarks History", 
    ...
    def create_homework_module(self, parent):
        ...
        tk.Label(header_content, text="📚 Homework Management", 
    ...
    def create_class_assignments_module(self, parent):
        ...
        quick_tasks = [
            ("📚 Reading Assignment", self.create_reading_task),
            ("✍️ Writing Task", self.create_writing_task),
            ("🧮 Math Practice", self.create_math_task),
    ...
    def add_new_homework(self):
        ...
        tk.Label(header, text="📚 Add New Homework Assignment", 
                font=('Segoe UI', 16, 'bold'), fg='white', bg='#28a745').pack(pady=15)
    ...
    def create_reading_task(self):
        ...
        self.create_quick_task("Reading Assignment", "📚")
    ...
    def create_math_task(self):
        ...
        self.create_quick_task("Math Practice", "🧮")
            ...
            if hasattr(self, 'selected_class') and self.selected_class.get():
                ...
                if class_result:
                    ...
                    for activity_type, title, date in activities[:6]:
                        ...
                        icon = "📚" if activity_type == "Homework" else "📝"
    ...
    def show_dashboard(self):
        ...
        if recent_students:
            for i, (name, class_name, admission_date) in enumerate(recent_students):
                ...
                # Class and date info
                class_text = f"   📚 {class_name} • Admitted: {admission_date}"
...
🎯 Total Active Students: {total_students}"""
    ...
    def show_student_management(self):
        ...
        update_btn = self.create_modern_button(button_container, "✏️ Update Student", 
    ...
    def show_class_management(self):
        ...
        name_label = tk.Label(name_section, text="🏷️ Class Name", 
        ...
        update_btn = self.create_enhanced_form_button(button_row, "✏️ Update", 
                                                     self.update_class, '#2980b9', '#3498db')
        update_btn.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 3))
        
        delete_btn = self.create_enhanced_form_button(button_row, "🗑️ Delete", 
    ...
    def show_teacher_management(self):
        ...
        photo_clear_btn = self.create_enhanced_form_button(photo_buttons_frame, "🗑️ Clear Photo", 
        ...
        clear_docs_btn = self.create_enhanced_form_button(docs_buttons_frame, "🗑️ Clear All", 
        ...
        update_btn = self.create_enhanced_form_button(button_row2, "✏️ Update Selected", 
                                                     self.update_teacher, '#e67e22', '#f39c12')
        update_btn.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 5))
        
        delete_btn = self.create_enhanced_form_button(button_row2, "🗑️ Delete Selected", 
    ...
    def update_teacher_documents_display(self):
        ...
        if not self.teacher_documents:
            ...
            for i, doc_path in enumerate(self.teacher_documents):
                ...
                # Remove button
                remove_btn = tk.Button(doc_frame, text="🗑️", font=('Segoe UI', 10), 
    ...
    def generate_teacher_profile(self):
        ...
        try:
            ...
            # Salary
            salary = f"GH¢ {teacher_data[4]:,.2f}" if teacher_data[4] else 'Not specified'
    ...
    def show_user_management(self):
        ...
        edit_user_btn = tk.Button(users_btn_frame, text="✏️ Edit User", 
        ...
        delete_user_btn = tk.Button(users_btn_frame, text="🗑️ Delete User", 
    ...
    def show_fees_management(self):
        ...
        update_btn = self.create_modern_button(btns, "✏️ Update Payment", self.update_fee, 'success', width=15)
        update_btn.grid(row=0, column=1, padx=5, pady=3)
        
        delete_btn = self.create_modern_button(btns, "🗑️ Delete Payment", self.delete_fee, 'danger', width=15)
...
• Balance: GHS {(total_due - total_paid):.2f}"""
    ...
    def create_transaction_management_tab(self):
        ...
        update_btn = tk.Button(buttons_frame, text="✏️ Update Transaction", 
                             command=self.update_transaction,
                             font=('Segoe UI', 10, 'bold'), bg='#3498db', fg='white',
                             relief='solid', bd=0, padx=15, pady=8, cursor='hand2')
        update_btn.pack(fill=tk.X, pady=(0, 8))
        
        delete_btn = tk.Button(buttons_frame, text="🗑️ Delete Transaction", 
    ...
    def create_category_management_tab(self):
        ...
        update_cat_btn = tk.Button(buttons_frame, text="✏️ Update Category", 
                                 command=self.update_category,
                                 font=('Segoe UI', 10, 'bold'), bg='#3498db', fg='white',
                                 relief='solid', bd=0, padx=15, pady=8, cursor='hand2')
        update_cat_btn.pack(fill=tk.X, pady=(0, 8))
        
        delete_cat_btn = tk.Button(buttons_frame, text="🗑️ Delete Category", 
    ...
    def create_budget_planning_tab(self):
        ...
        update_btn = tk.Button(buttons_frame, text="✏️ Update Budget", 
                              command=self.update_budget,
                              font=('Segoe UI', 10, 'bold'), bg='#3498db', fg='white',
                              relief='solid', bd=0, padx=15, pady=8, cursor='hand2')
        update_btn.pack(fill=tk.X, pady=(0, 8))
        
        delete_btn = tk.Button(buttons_frame, text="🗑️ Delete Budget", 
        ...
        try:
            ...
            if recent_transactions:
                ...
                for transaction in recent_transactions:
                    ...
                    # Date and time
                    date_time = tk.Label(details_frame, text=f"📅 {transaction[0]} • ⏰ {transaction[5][:10]}", 
    ...
    def show_backup_restore_menu(self):
        ...
        tk.Button(backup_options_frame, text="🗂️ Full Database Backup", 
        ...
        # Restore Section
        restore_section = tk.LabelFrame(content_area, text="📥 Restore Database", 
                                       font=('Segoe UI', 14, 'bold'), bg='white', 
                                       fg='#2c3e50', relief=tk.RAISED, bd=2)
        ...
        tk.Button(restore_content, text="📂 Restore from Backup File", 
...
"""
    ...
    def show_advanced_analytics_window(self, student_id):
        ...
        att_icon = trend_icons.get(trends['attendance_trend'], '➡️')
        ...
        fee_icon = trend_icons.get(trends['fee_trend'], '➡️')
